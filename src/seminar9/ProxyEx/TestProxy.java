package seminar9.ProxyEx;

import seminar9.ProxyEx.proxy.Imagine;
import seminar9.ProxyEx.proxy.InterfataImagine;
import seminar9.ProxyEx.proxy.ProxyImagine;
import seminar9.ProxyEx.proxy2.InterfataLogin;
import seminar9.ProxyEx.proxy2.Login;
import seminar9.ProxyEx.proxy2.ProxyLoginSecurizat;

public class TestProxy {

	public static void main(String[] args) {
		InterfataImagine img1 = new Imagine("Car.png");
		...
		img1.afisareImagine();
         ...
         final InterfataImagine IMAGE1 = new ProxyImagine("Photo1");
         final InterfataImagine IMAGE2 = new ProxyImagine("Photo2");
